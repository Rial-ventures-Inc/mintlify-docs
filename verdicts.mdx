...
| `reason_code` | Why it isn't `verified`: `screen_detected`, `ai_generated`, `context_mismatch`, `reverse_search_match`, `depth_anomaly`. |
...
| `depth` | Does the depth sensor agree it's a real scene? |
