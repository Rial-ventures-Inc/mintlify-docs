...
Treat the event as a notification. Before you act on it, confirm with `verifications.get(event.verificationId)`.
...
const template = await rial.templates.publish({
  ...
  steps: [
    ...
    },
    {
      ...
      label: 'Odometer',
      type: 'image',
      description: 'Please take a photo of the odometer showing the mileage',
    },
    {
      key: 'plate',
      label: 'License plate',
      type: 'text',
      description: 'Please type your license plate number',
    },
  ],
